...
Here, we can see that the adults in the fishery typically stay their starting position, which matches well with what we would expect for a reef-associated species with a small home range. 
